...
var ImageUploader = ({ onImageSelect }) => {
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs("label", { className: "flex flex-col items-center justify-center w-full h-full cursor-pointer", children: [
        /* @__PURE__ */ jsx(UploadCloud, { className: "w-12 h-12 text-gray-400 group-hover:text-blue-500 mb-4 transition-colors" }),
        /* @__PURE__ */ jsxs("p", { className: "mb-2 text-sm text-gray-300", children: [
          /* @__PURE__ */ jsx("span", { className: "font-semibold", children: "Click to upload" }),
          " or drag and drop"
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500", children: "JPG, PNG, WEBP (Max 20MB)" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "file",
...
var useCanvasInteraction = (initialCrop, imageWidth, imageHeight, canvasWidth, canvasHeight, aspectRatio) => {
  const [crop, setCrop] = useState2(initialCrop);
  const isDragging = useRef2(null);
  const dragStart = useRef2({ x: 0, y: 0 });
  const cropStart = useRef2({ ...initialCrop });
...
var CropCanvas = ({ image, onCropChange, aspectRatio, initialCrop }) => {
  ...
  const overlayCanvasRef = useRef3(null);
  const [dimensions, setDimensions] = useState3({ width: 0, height: 0 });
...
var DimensionControls = ({
  ...
  return /* @__PURE__ */ jsxs3("div", { className: "flex flex-col gap-4 p-4 bg-gray-900 rounded-xl border border-gray-800 transition-all hover:border-gray-700/80", children: [
    /* @__PURE__ */ jsx3("h3", { className: "text-sm font-semibold text-gray-300 uppercase tracking-wider", children: "Dimensions" }),
    /* @__PURE__ */ jsxs3("div", { children: [
      /* @__PURE__ */ jsx3("label", { htmlFor: "unit-select", className: "block text-xs text-gray-500 mb-1 font-medium", children: "Unit" }),
      /* @__PURE__ */ jsxs3(
        "select",
        {
          id: "unit-select",
          ...
          children: [
            /* @__PURE__ */ jsx3("option", { value: "px", children: "Pixels (px)" }),
            /* @__PURE__ */ jsx3("option", { value: "mm", children: "Millimeters (mm)" }),
            /* @__PURE__ */ jsx3("option", { value: "cm", children: "Centimeters (cm)" }),
            /* @__PURE__ */ jsx3("option", { value: "in", children: "Inches (in)" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxs3("div", { className: "grid grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxs3("div", { children: [
        /* @__PURE__ */ jsx3("label", { htmlFor: "width-input", className: "block text-xs text-gray-500 mb-1 font-medium", children: "Width" }),
        /* @__PURE__ */ jsx3(
          "input",
          {
            id: "width-input",
      ...
      /* @__PURE__ */ jsxs3("div", { children: [
        /* @__PURE__ */ jsx3("label", { htmlFor: "height-input", className: "block text-xs text-gray-500 mb-1 font-medium", children: "Height" }),
        /* @__PURE__ */ jsx3(
          "input",
          {
            id: "height-input",
    ...
    unit !== "px" && /* @__PURE__ */ jsxs3("div", { className: "flex flex-col gap-3 border-t border-gray-800/60 pt-3", children: [
      /* @__PURE__ */ jsxs3("label", { className: "flex items-center gap-2 cursor-pointer select-none text-xs text-gray-400 hover:text-white transition-colors", children: [
        /* @__PURE__ */ jsx3(
          "input",
          {
            type: "checkbox",
      ...
      hasFixedDpi ? /* @__PURE__ */ jsxs3("div", { className: "animate-in fade-in duration-200", children: [
        /* @__PURE__ */ jsx3("label", { htmlFor: "dpi-input", className: "block text-xs text-gray-500 mb-1 font-medium", children: "DPI" }),
        /* @__PURE__ */ jsx3(
          "input",
          {
            id: "dpi-input",
      ...
      ] }) : /* @__PURE__ */ jsxs3("div", { className: "text-[11px] text-blue-400 bg-blue-950/20 border border-blue-500/20 rounded-lg p-2.5 leading-relaxed", children: [
        "\u2139\uFE0F DPI will be optimized dynamically to fit your target KB exactly ",
        /* @__PURE__ */ jsx3("strong", { children: "without any blur" }),
        "."
      ] })
    ] })
  ] });
...
var CompressionControls = ({
  ...
  return /* @__PURE__ */ jsxs4("div", { className: "flex flex-col gap-4 p-4 bg-gray-900 rounded-xl border border-gray-800 transition-all hover:border-gray-700/80", children: [
    /* @__PURE__ */ jsx4("h3", { className: "text-sm font-semibold text-gray-300 uppercase tracking-wider", children: "Compression Engine" }),
    /* @__PURE__ */ jsxs4("div", { className: "flex flex-col gap-4", children: [
      /* @__PURE__ */ jsxs4("div", { children: [
        /* @__PURE__ */ jsx4("label", { htmlFor: "format-select", className: "block text-xs text-gray-500 mb-1 font-medium", children: "Output Format" }),
        /* @__PURE__ */ jsxs4(
          "select",
          {
            id: "format-select",
            ...
            className: "w-full bg-gray-950 text-white rounded-lg border border-gray-750 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all appearance-none cursor-pointer",
            children: [
              /* @__PURE__ */ jsx4("option", { value: "image/jpeg", children: "JPEG (Highly Recommended)" }),
              /* @__PURE__ */ jsx4("option", { value: "image/webp", children: "WEBP (Modern / Lossy)" }),
              /* @__PURE__ */ jsx4("option", { value: "image/png", children: "PNG (Lossless / Large)" })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxs4("div", { children: [
        /* @__PURE__ */ jsx4("label", { htmlFor: "target-size-input", className: "block text-xs text-gray-500 mb-1 font-medium", children: "Target Size (KB)" }),
        /* @__PURE__ */ jsx4(
          "input",
          {
        ...
        /* @__PURE__ */ jsxs4("span", { className: "block text-[10px] text-gray-400 mt-1.5", children: [
          "Min recommended: ",
          /* @__PURE__ */ jsxs4("strong", { className: "text-blue-400", children: [
            minPossibleKB,
            " KB"
          ] })
        ] })
    ...
    targetSizeKB < minPossibleKB && /* @__PURE__ */ jsxs4("div", { className: "p-3 bg-amber-950/40 border border-amber-500/30 rounded-lg text-amber-200 text-xs flex flex-col gap-1 mt-1 transition-all", children: [
      /* @__PURE__ */ jsx4("span", { className: "font-semibold flex items-center gap-1", children: "\u26A0\uFE0F Quality Degradation Alert" }),
      /* @__PURE__ */ jsx4("span", { children: format === "image/png" ? `PNG is lossless. Compressing this image below ${minPossibleKB}KB requires aggressive noise removal. We highly recommend JPEG or WEBP for photos.` : `At these dimensions, a target size below ${minPossibleKB}KB will result in visible compression blockiness. We recommend increasing the size limit.` })
    ] }),
    /* @__PURE__ */ jsx4("p", { className: "text-xs text-gray-500 italic mt-1 leading-relaxed", children: "tenPixel uses dynamic binary search optimization to hit the target file size efficiently." })
  ] });
};
